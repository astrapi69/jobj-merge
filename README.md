...
[![Build Status](https://api.travis-ci.com/astrapi69/jobj-merge.svg?branch=develop)](https://travis-ci.com/github/astrapi69/jobj-merge)
...
The source code comes under the liberal MIT License, making jobj-merge great for all types of
applications.
...
your project `build.gradle` if you want to import the core functionality of jobj-merge:
...
To share your
changes, [submit a pull request](https://github.com/astrapi69/jobj-merge/pull/new/develop).

Don't forget to add new units tests on your changes.

## Contacting the Developers

Do not hesitate to contact the jobj-merge developers with your questions, concerns, comments, bug
